    ...
    <section class="contact-section">
            <div class="container">
               <div class="row">
                    ...
                    <div class="col-lg-8">
                        <form class="form-contact contact_form" action="customerchangepassworddata.jsp" method="post" >
                            <div class="row">
                               
                                <%String email=(String)session.getAttribute("email"); %>
                                <div class="col-md-8">
                                    <div class="form-group">
                                        <input class="form-control valid" required  readonly value="<%=email %>" name="email"  type="email" onfocus="this.placeholder = 'Enter Email Address'" onblur="this.placeholder = 'Enter Email Address'" placeholder="Enter Email Address">
                                    </div> 
                                </div>
                                <div class="col-md-8">
                                    <div class="form-group">
