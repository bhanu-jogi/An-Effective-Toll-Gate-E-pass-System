    ...
    <section class="contact-section">
            <div class="container">
               <div class="row">
                    ...
                    <div class="col-lg-8">
                        <form class="form-contact contact_form" action="customerdata.jsp" method="post" >
                            <div class="row">
                            ...
                            <div class="form-group mt-3">
                                <button type="submit" class="genric-btn danger e-large">LOGIN</button>
                                <a class="genric-btn primary e-large" href="customerregister.jsp">REGISTER</a>
                            </div>
                        </form>
                    </div>
